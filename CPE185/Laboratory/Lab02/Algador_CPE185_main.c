...
static void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOA, EW_RED_LED_Pin|EW_YELLOW_LED_Pin|EW_GREEN_LED_Pin|NS_RED_LED_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, NS_GREEN_LED_Pin|NS_YELLOW_LED_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pins : EW_RED_LED_Pin EW_YELLOW_LED_Pin EW_GREEN_LED_Pin NS_RED_LED_Pin */
  GPIO_InitStruct.Pin = EW_RED_LED_Pin|EW_YELLOW_LED_Pin|EW_GREEN_LED_Pin|NS_RED_LED_Pin;
